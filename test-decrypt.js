...
const combinations = [
    ...
    { keyEnc: 'hex',  ivEnc: 'hex',  algo: 'aes-128-cbc' },
    { keyEnc: 'hex',  ivEnc: 'utf8', algo: 'aes-128-cbc' },
    { keyEnc: 'utf8', ivEnc: 'utf8', algo: 'aes-256-gcm' },
    { keyEnc: 'utf8', ivEnc: 'hex',  algo: 'aes-256-gcm' },
    { keyEnc: 'hex',  ivEnc: 'hex',  algo: 'aes-128-gcm' },
    { keyEnc: 'hex',  ivEnc: 'utf8', algo: 'aes-128-gcm' },
];
